...
class Bullet():
    def __init__(self,tank):
        ...
        if self.direction == 'U':
            ...
            self.rect.top = tank.rect.top + tank.rect.height/2 - self.rect.height/1.4 #可能是图片的原因，所以使用的1.4
        elif self.direction == 'R':
            self.rect.left = tank.rect.left + tank.rect.width
            self.rect.top = tank.rect.top + tank.rect.height/2 - self.rect.height/1.4
