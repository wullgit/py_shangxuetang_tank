...
class Bullet():
    def __init__(self,tank):
        #图片
        self.images = {
            'U': pygame.image.load('img/bullet_up.png'),
            'D': pygame.image.load('img/bullet_down.png'),
            'L': pygame.image.load('img/bullet_left.png'),
            'R': pygame.image.load('img/bullet_right.png')
        }
        #方向（坦克方向）
        ...
        if self.direction == 'U':
            self.left = tank.rect.left + tank.rect.width/2 - self.rect.width/2
            self.top = tank.rect.top - self.rect.height
        elif self.direction == 'D':
            self.left = tank.rect.left + tank.rect.width / 2 - self.rect.width / 2
            self.top = tank.rect.top + self.rect.height
        elif self.direction == 'L':
            self.left = tank.rect.left - self.rect.width
            self.top = tank.rect.top + self.rect.height/2 - self.rect.height/2
        elif self.direction == 'R':
            self.left = tank.rect.left + self.rect.width
            self.top = tank.rect.top + self.rect.height / 2 - self.rect.height / 2
